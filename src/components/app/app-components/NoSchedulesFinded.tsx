...
export const NoSchedulesFinded = () => {
  return (
    <section className="p-4 rounded-lg w-full min-h-96 text-center flex flex-col items-center justify-center gap-8">
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="text-2xl font-bold text-red-300">No hay horarios</p>
      </div>
    <a href='#create-schedule' className="bg-red-400 text-white font-bold py-2 px-8 rounded scale-100 active:scale-105 ease-out active:bg-red-500 transition-all flex gap-4 items-center">
